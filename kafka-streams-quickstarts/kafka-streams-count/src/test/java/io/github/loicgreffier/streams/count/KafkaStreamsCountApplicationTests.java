...
class KafkaStreamsCountApplicationTests {
    private static final String SCHEMA_REGISTRY_SCOPE = KafkaStreamsCountApplicationTests.class.getName();
    ...
    void shouldCountByNationality() {
        inputTopic.pipeInput("1", buildKafkaPerson("Aaran", "Allen", CountryCode.FR));
        inputTopic.pipeInput("2", buildKafkaPerson("Bret", "Wise", CountryCode.CH));
        inputTopic.pipeInput("3", buildKafkaPerson("Brendan", "Allen", CountryCode.FR));
        inputTopic.pipeInput("4", buildKafkaPerson("Jude", "Wise", CountryCode.ES));
