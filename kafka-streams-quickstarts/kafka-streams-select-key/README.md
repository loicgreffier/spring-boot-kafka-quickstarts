...
- Produce records of type <String,KafkaUser> to a topic named USER_TOPIC. You can use the [producer user](../specific-producers/kafka-streams-producer-user) for this.
