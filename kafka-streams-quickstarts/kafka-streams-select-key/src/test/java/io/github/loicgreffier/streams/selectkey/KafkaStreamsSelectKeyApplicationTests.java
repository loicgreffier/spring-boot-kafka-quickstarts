...
class KafkaStreamsSelectKeyApplicationTests {
    private static final String SCHEMA_REGISTRY_SCOPE = KafkaStreamsSelectKeyApplicationTests.class.getName();
    ...
    void setUp() {
        ...
        outputTopic = testDriver.createOutputTopic(PERSON_SELECT_KEY_TOPIC, new StringDeserializer(), personSerde.deserializer());
    }
    ...
    void shouldSelectLastNameAsNewKey() {
        ...
        assertThat(results.get(0)).isEqualTo(KeyValue.pair("Allen", person));
    }
