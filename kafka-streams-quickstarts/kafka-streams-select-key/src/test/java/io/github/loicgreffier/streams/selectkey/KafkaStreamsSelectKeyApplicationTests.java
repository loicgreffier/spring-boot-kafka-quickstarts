...
class KafkaStreamsSelectKeyApplicationTests {
    private static final String SCHEMA_REGISTRY_SCOPE =
        KafkaStreamsSelectKeyApplicationTests.class.getName();
    ...
    void setUp() {
        ...
        outputTopic =
            testDriver.createOutputTopic(PERSON_SELECT_KEY_TOPIC, new StringDeserializer(),
    ...
    void shouldSelectLastNameAsNewKey() {
        ...
        assertThat(results.get(0)).isEqualTo(KeyValue.pair("Doe", person));
    }
