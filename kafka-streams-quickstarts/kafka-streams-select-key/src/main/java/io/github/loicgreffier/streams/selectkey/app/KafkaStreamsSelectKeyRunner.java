...
import io.github.loicgreffier.streams.selectkey.properties.KafkaStreamsProperties;
...
@Slf4j
@Component
public class KafkaStreamsSelectKeyRunner implements ApplicationRunner {
    @Autowired
