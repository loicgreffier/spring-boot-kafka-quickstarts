...
This module streams records of type `<String, KafkaUser>` from the `USER_TOPIC` and aggregates users by their last name using a 5-minute sliding window and a 1-minute grace period for delayed records.
