...
public class KafkaStreamsTopology {
     ...
     * {@link io.github.loicgreffier.streams.process.constants.Topic#PERSON_TOPIC} topic
     * and processes the records with the {@link PersonMetadataProcessor} processor.
     * The result is written to the {@link
     * io.github.loicgreffier.streams.process.constants.Topic#PERSON_PROCESS_TOPIC} topic.
     *
