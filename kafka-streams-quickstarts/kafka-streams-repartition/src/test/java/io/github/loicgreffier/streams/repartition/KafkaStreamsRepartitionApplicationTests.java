...
class KafkaStreamsRepartitionApplicationTests {
    private static final String SCHEMA_REGISTRY_SCOPE = KafkaStreamsRepartitionApplicationTests.class.getName();
    ...
    void setUp() {
        ...
        outputTopic = testDriver.createOutputTopic("streams-repartition-test-" + PERSON_TOPIC + "-repartition", new StringDeserializer(),
