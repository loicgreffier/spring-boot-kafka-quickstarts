...
class KafkaStreamsRepartitionApplicationTest {
    private static final String CLASS_NAME = KafkaStreamsRepartitionApplicationTest.class.getName();
    ...
    void setUp() {
        ...
        properties.setProperty(APPLICATION_ID_CONFIG, "streams-repartition-test");
