...
import io.github.loicgreffier.streams.repartition.properties.KafkaStreamsProperties;
...
@Slf4j
@Component
public class KafkaStreamsRepartitionRunner implements ApplicationRunner {
    @Autowired
