...
import io.lgr.quickstarts.streams.mapvalues.properties.StreamsProperties;
...
@Slf4j
@Component
public class KafkaStreamsMapValuesRunner implements ApplicationRunner {
    @Autowired
    ...
    public void run(ApplicationArguments args) {
        ...
        Topology topology = KafkaStreamsMapValuesTopology.topology();
