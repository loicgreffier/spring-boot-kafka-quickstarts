...
import io.github.loicgreffier.streams.mapvalues.app.KafkaStreamsMapValuesTopology;
...
class KafkaStreamsMapValuesTest {
    private static final String SCHEMA_REGISTRY_SCOPE = KafkaStreamsMapValuesTest.class.getName();
    ...
    void setUp() {
        ...
        outputTopic = testDriver.createOutputTopic(PERSON_MAP_VALUES_TOPIC, new StringDeserializer(), personSerde.deserializer());
    }
