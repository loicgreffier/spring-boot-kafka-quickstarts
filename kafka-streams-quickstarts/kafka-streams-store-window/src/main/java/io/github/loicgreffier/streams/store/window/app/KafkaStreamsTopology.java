...
public class KafkaStreamsTopology {
     ...
     * the {@link PutInStoreProcessor} processor that puts the records in a {@link WindowStore} state store. It
     * demonstrates the two strategies to use a state store in a processor:
     *
     * <ul>
    ...
    public static void topology(StreamsBuilder streamsBuilder) {
        final StoreBuilder<WindowStore<String, KafkaUser>> storeBuilder = Stores.windowStoreBuilder(
                Stores.persistentWindowStore(USER_WINDOW_STORE, Duration.ofMinutes(10), Duration.ofMinutes(5), false),
                Serdes.String(),
        ...
        streamsBuilder.<String, KafkaUser>stream(
                ...
                .process(new ProcessorSupplier<String, KafkaUser, String, KafkaUser>() {
                    ...
                    public Set<StoreBuilder<?>> stores() {
                        StoreBuilder<WindowStore<String, KafkaUser>> supplierStoreBuilder = Stores.windowStoreBuilder(
