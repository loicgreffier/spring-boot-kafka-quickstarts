...
class KafkaStreamsFlatMapApplicationTests {
    private static final String SCHEMA_REGISTRY_SCOPE = KafkaStreamsFlatMapApplicationTests.class.getName();
    ...
    void setUp() {
        ...
        outputTopic = testDriver.createOutputTopic(PERSON_FLATMAP_TOPIC, new StringDeserializer(), new StringDeserializer());
    }
    ...
    void shouldChangeKeyAndFlatMapFirstNameAndLastName() {
        ...
        assertThat(results.get(0)).isEqualTo(KeyValue.pair("AARAN", "Aaran"));
        assertThat(results.get(1)).isEqualTo(KeyValue.pair("ALLEN", "Allen"));
    }
