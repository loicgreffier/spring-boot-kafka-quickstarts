...
class KafkaStreamsScheduleStoreCleanupApplicationTests {
    private static final String SCHEMA_REGISTRY_SCOPE = KafkaStreamsScheduleStoreCleanupApplicationTests.class.getName();
    ...
    void shouldFillAndCleanupStore() {
        ...
        KafkaPerson secondPerson = buildKafkaPerson("Brendan", "Abbott", CountryCode.ES);
        KafkaPerson thirdPerson = buildKafkaPerson("Bret", "Holman", CountryCode.FR);
        KafkaPerson fourthPerson = buildKafkaPerson("Daimhin", "Abbott", CountryCode.GB);
        KafkaPerson fifthPerson = buildKafkaPerson("Jiao", "Patton", CountryCode.GB);

        inputTopic.pipeInput(new TestRecord<>("1", firstPerson, Instant.parse("2000-01-01T01:00:00.00Z")));
        inputTopic.pipeInput(new TestRecord<>("2", secondPerson, Instant.parse("2000-01-01T01:00:20.00Z")));
        inputTopic.pipeInput(new TestRecord<>("3", thirdPerson, Instant.parse("2000-01-01T01:00:40.00Z")));
        ...
        inputTopic.pipeInput(new TestRecord<>("5", fifthPerson, Instant.parse("2000-01-01T01:02:30.00Z")));
