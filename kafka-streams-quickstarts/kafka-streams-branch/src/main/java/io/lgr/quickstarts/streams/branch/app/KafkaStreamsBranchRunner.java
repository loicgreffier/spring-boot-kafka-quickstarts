package io.lgr.quickstarts.streams.branch.app;

import io.lgr.quickstarts.streams.branch.properties.StreamsProperties;
...
@Slf4j
@Component
public class KafkaStreamsBranchRunner implements ApplicationRunner {
    @Autowired
