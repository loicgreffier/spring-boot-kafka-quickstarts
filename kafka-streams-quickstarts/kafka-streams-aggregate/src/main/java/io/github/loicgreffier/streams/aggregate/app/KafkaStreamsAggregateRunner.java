...
import io.github.loicgreffier.streams.aggregate.properties.KafkaStreamsProperties;
...
@Slf4j
@Component
public class KafkaStreamsAggregateRunner implements ApplicationRunner {
    @Autowired
