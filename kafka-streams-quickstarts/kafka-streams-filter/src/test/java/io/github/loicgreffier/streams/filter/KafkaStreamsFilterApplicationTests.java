...
class KafkaStreamsFilterApplicationTests {
    private static final String SCHEMA_REGISTRY_SCOPE = KafkaStreamsFilterApplicationTests.class.getName();
    ...
    void setUp() {
        ...
        outputTopic = testDriver.createOutputTopic(PERSON_FILTER_TOPIC, new StringDeserializer(), personSerde.deserializer());
    }
    ...
    void shouldFilterBadLastName() {
        inputTopic.pipeInput("1", buildKafkaPerson("Bret", "Wise"));
    ...
    void shouldFilterBadFirstName() {
        inputTopic.pipeInput("1", buildKafkaPerson("Diego", "Allen"));
    ...
    void shouldNotFilter() {
        KafkaPerson person = buildKafkaPerson("Akan", "Allen");
