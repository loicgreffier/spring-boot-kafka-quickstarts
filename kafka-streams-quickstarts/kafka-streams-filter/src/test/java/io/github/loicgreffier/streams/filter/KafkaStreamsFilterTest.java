...
import io.github.loicgreffier.streams.filter.app.KafkaStreamsFilterTopology;
...
class KafkaStreamsFilterTest {
    private static final String SCHEMA_REGISTRY_SCOPE = KafkaStreamsFilterTest.class.getName();
