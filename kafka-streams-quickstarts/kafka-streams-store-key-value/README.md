...
1. Create a first stream that pushes records to a Key-Value store named `PERSON_KEY_VALUE_STORE`.
2. Create a second stream that pushes records to another Key-Value store named `PERSON_KEY_VALUE_SUPPLIER_STORE`.
