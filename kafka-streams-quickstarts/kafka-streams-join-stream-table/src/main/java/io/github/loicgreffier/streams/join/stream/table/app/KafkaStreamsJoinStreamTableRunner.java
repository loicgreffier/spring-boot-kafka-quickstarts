...
import io.github.loicgreffier.streams.join.stream.table.properties.StreamsProperties;
...
@Slf4j
@Component
public class KafkaStreamsJoinStreamTableRunner implements ApplicationRunner {
    @Autowired
