...
class KafkaStreamsJoinStreamTableApplicationTests {
    private static final String SCHEMA_REGISTRY_SCOPE = KafkaStreamsJoinStreamTableApplicationTests.class.getName();
    ...
    void setUp() {
        ...
        rekeyPersonOutputTopic = testDriver.createOutputTopic("streams-join-stream-table-test-" + PERSON_JOIN_STREAM_TABLE_REKEY_TOPIC + "-repartition", new StringDeserializer(), personSerde.deserializer());
        joinOutputTopic = testDriver.createOutputTopic(PERSON_COUNTRY_JOIN_STREAM_TABLE_TOPIC, new StringDeserializer(), joinPersonCountrySerde.deserializer());
    }
