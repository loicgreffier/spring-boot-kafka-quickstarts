 ...
 */
class KafkaStreamsJoinStreamTableApplicationTests {
    private static final String SCHEMA_REGISTRY_SCOPE =
        KafkaStreamsJoinStreamTableApplicationTests.class.getName();
    ...
    void setUp() {
        ...
        properties.setProperty(StreamsConfig.APPLICATION_ID_CONFIG,
            "streams-join-stream-table-test");
        ...
        rekeyPersonOutputTopic = testDriver.createOutputTopic(
            "streams-join-stream-table-test-" + PERSON_JOIN_STREAM_TABLE_REKEY_TOPIC
                + "-repartition", new StringDeserializer(), personSerde.deserializer());
        joinOutputTopic = testDriver.createOutputTopic(PERSON_COUNTRY_JOIN_STREAM_TABLE_TOPIC,
    ...
    void shouldRekey() {
        ...
        assertThat(results.get(0)).isEqualTo(KeyValue.pair("FR", person));
    }
