 ...
 */
class KafkaStreamsMapApplicationTest {
    private static final String CLASS_NAME = KafkaStreamsMapApplicationTest.class.getName();
    ...
    void setUp() {
        ...
        properties.setProperty(APPLICATION_ID_CONFIG, "streams-map-test");
    ...
    void shouldChangeKeyAndUpperCase() {
        ...
        assertEquals("JOHN", results.get(0).value.getFirstName());
        assertEquals("DOE", results.get(0).value.getLastName());
    }
