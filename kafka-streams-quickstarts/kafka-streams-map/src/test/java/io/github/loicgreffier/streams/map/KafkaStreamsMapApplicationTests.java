...
class KafkaStreamsMapApplicationTests {
    private static final String SCHEMA_REGISTRY_SCOPE = KafkaStreamsMapApplicationTests.class.getName();
    ...
    void setUp() {
        ...
        outputTopic = testDriver.createOutputTopic(PERSON_MAP_TOPIC, new StringDeserializer(), personSerde.deserializer());
    }
