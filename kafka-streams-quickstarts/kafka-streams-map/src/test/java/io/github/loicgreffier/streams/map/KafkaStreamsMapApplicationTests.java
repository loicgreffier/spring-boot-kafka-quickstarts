...
class KafkaStreamsMapApplicationTests {
    private static final String SCHEMA_REGISTRY_SCOPE =
        KafkaStreamsMapApplicationTests.class.getName();
    ...
    void setUp() {
        ...
        outputTopic = testDriver.createOutputTopic(PERSON_MAP_TOPIC, new StringDeserializer(),
    ...
    void shouldChangeKeyAndUpperCase() {
        ...
        assertThat(results.get(0).value.getFirstName()).isEqualTo("JOHN");
        assertThat(results.get(0).value.getLastName()).isEqualTo("DOE");
    }
