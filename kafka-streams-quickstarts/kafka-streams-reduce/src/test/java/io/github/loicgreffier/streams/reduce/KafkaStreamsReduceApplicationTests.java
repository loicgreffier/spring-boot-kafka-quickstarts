...
class KafkaStreamsReduceApplicationTests {
    private static final String SCHEMA_REGISTRY_SCOPE = KafkaStreamsReduceApplicationTests.class.getName();
    ...
    void setUp() {
        ...
        outputTopic = testDriver.createOutputTopic(PERSON_REDUCE_TOPIC, new StringDeserializer(), personSerde.deserializer());
    }
    ...
    void shouldReduceByNationalityAndKeepMaxAge() {
        KafkaPerson oldestFr = buildKafkaPerson("Aaran", "Allen", Instant.parse("1956-08-29T18:35:24.00Z"), CountryCode.FR);
        KafkaPerson youngestFr = buildKafkaPerson("Brendan", "Allen", Instant.parse("1994-11-09T08:08:50.00Z"), CountryCode.FR);
        KafkaPerson youngestGb = buildKafkaPerson("Bret", "Wise", Instant.parse("1996-02-02T04:58:01.00Z"), CountryCode.GB);
        KafkaPerson oldestGb = buildKafkaPerson("Bret", "Wise", Instant.parse("1986-05-26T04:52:06Z"), CountryCode.GB);
    ...
    private KafkaPerson buildKafkaPerson(String firstName, String lastName, Instant birthDate, CountryCode nationality) {
