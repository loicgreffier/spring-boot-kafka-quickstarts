...
import io.github.loicgreffier.streams.reduce.app.KafkaStreamsReduceTopology;
...
class KafkaStreamsReduceTest {
    private static final String SCHEMA_REGISTRY_SCOPE = KafkaStreamsReduceTest.class.getName();
