...
class KafkaStreamsAverageApplicationTests {
    private static final String SCHEMA_REGISTRY_SCOPE =
        KafkaStreamsAverageApplicationTests.class.getName();
    ...
    void setUp() {
        ...
        outputTopic = testDriver.createOutputTopic(PERSON_AVERAGE_TOPIC, new StringDeserializer(),
    ...
    void shouldComputeAverageAgeByNationality() {
        ...
        // Check state store
        KeyValueStore<String, KafkaAverageAge> stateStore =
            testDriver.getKeyValueStore(PERSON_AVERAGE_STATE_STORE);
