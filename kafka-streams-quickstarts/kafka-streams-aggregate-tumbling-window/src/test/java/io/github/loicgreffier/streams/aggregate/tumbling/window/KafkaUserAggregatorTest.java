...
import io.github.loicgreffier.streams.aggregate.tumbling.window.app.aggregator.KafkaUserAggregator;
import java.time.Instant;
import java.util.ArrayList;
import java.util.List;
import org.junit.jupiter.api.Test;

class KafkaUserAggregatorTest {
    @Test
    void shouldAggregateUsers() {
        KafkaUserAggregator aggregator = new KafkaUserAggregator();
        ...
        assertTrue(group.getUsers().containsAll(List.of(homer, marge)));
    }
