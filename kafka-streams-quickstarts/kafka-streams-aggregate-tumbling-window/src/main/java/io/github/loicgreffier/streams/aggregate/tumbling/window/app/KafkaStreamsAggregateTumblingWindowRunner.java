...
import io.github.loicgreffier.streams.aggregate.tumbling.window.properties.KafkaStreamsProperties;
...
@Slf4j
@Component
public class KafkaStreamsAggregateTumblingWindowRunner implements ApplicationRunner {
    @Autowired
