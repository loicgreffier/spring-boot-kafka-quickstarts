...
public class KafkaStreamsTopology {
     ...
     * if the birthdate is negative. These exceptions are handled by the
    ...
    public static void topology(StreamsBuilder streamsBuilder) {
        streamsBuilder.<String, KafkaUser>stream(
                ...
                .to(USER_EXCEPTION_HANDLER_OUTPUT_TOPIC, Produced.with(Serdes.String(), SerdesUtils.getValueSerdes()));
    }
