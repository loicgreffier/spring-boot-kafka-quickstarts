...
- The use of the Kafka Streams API: `windowedBy().advanceBy()`, `aggregate()`, `groupByKey()`, `selectKey()`, `toStream()`, `peek()`.
...
- Write the result into a new topic named PERSON_AGGREGATE_HOPPING_WINDOW_TOPIC.
