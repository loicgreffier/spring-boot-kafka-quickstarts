...
import io.github.loicgreffier.streams.aggregate.hopping.window.properties.KafkaStreamsProperties;
...
@Slf4j
@Component
public class KafkaStreamsAggregateHoppingWindowRunner implements ApplicationRunner {
    @Autowired
