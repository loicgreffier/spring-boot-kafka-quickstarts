...
public class KafkaStreamsTopology {
     ...
     * The result is written to the USER_AGGREGATE_HOPPING_WINDOW_TOPIC topic.
     *
     * <p>
    ...
    public static void topology(StreamsBuilder streamsBuilder) {
        streamsBuilder
            ...
            .aggregate(
                ...
                Materialized
                    .<String, KafkaUserGroup, WindowStore<Bytes, byte[]>>as(USER_AGGREGATE_HOPPING_WINDOW_STORE)
