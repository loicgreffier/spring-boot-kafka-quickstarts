...
import io.github.loicgreffier.streams.left.join.stream.stream.properties.KafkaStreamsProperties;
...
@Slf4j
@Component
public class KafkaStreamsLeftJoinStreamStreamRunner implements ApplicationRunner {
    @Autowired
