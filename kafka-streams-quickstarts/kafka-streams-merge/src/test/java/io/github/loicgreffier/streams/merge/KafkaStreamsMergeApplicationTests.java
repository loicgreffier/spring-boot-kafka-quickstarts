...
class KafkaStreamsMergeApplicationTests {
    private static final String SCHEMA_REGISTRY_SCOPE = KafkaStreamsMergeApplicationTests.class.getName();
    ...
    void setUp() {
        ...
        outputTopic = testDriver.createOutputTopic(PERSON_MERGE_TOPIC, new StringDeserializer(), personSerde.deserializer());
    }
    ...
    void shouldMergeBothStreams() {
        KafkaPerson firstPerson = buildKafkaPerson("Aaran", "Abbott");
        KafkaPerson secondPerson = buildKafkaPerson("Brendan", "Tillman");
