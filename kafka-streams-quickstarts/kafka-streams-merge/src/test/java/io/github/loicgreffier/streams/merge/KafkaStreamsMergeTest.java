...
import io.github.loicgreffier.streams.merge.app.KafkaStreamsMergeTopology;
...
class KafkaStreamsMergeTest {
    private static final String SCHEMA_REGISTRY_SCOPE = KafkaStreamsMergeTest.class.getName();
