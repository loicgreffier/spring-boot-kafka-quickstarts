...
class KafkaStreamsLeftJoinStreamTableTest {
    private static final String SCHEMA_REGISTRY_SCOPE = KafkaStreamsLeftJoinStreamTableTest.class.getName();
    ...
    void setUp() {
        ...
        personRekeyOutputTopic = testDriver.createOutputTopic("streams-left-join-stream-table-test-" + PERSON_LEFT_JOIN_STREAM_TABLE_REKEY_TOPIC + "-repartition", new StringDeserializer(), personSerde.deserializer());
