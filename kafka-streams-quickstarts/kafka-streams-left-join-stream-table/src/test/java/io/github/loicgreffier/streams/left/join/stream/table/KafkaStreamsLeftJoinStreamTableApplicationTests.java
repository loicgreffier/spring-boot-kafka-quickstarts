...
class KafkaStreamsLeftJoinStreamTableApplicationTests {
    private static final String SCHEMA_REGISTRY_SCOPE = KafkaStreamsLeftJoinStreamTableApplicationTests.class.getName();
    ...
    void setUp() {
        ...
        rekeyPersonOutputTopic = testDriver.createOutputTopic("streams-left-join-stream-table-test-" + PERSON_LEFT_JOIN_STREAM_TABLE_REKEY_TOPIC + "-repartition", new StringDeserializer(), personSerde.deserializer());
        joinOutputTopic = testDriver.createOutputTopic(PERSON_COUNTRY_LEFT_JOIN_STREAM_TABLE_TOPIC, new StringDeserializer(), joinPersonCountrySerde.deserializer());
    }
