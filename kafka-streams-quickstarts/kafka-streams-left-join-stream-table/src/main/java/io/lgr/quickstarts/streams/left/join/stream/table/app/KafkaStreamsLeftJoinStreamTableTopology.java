package io.lgr.quickstarts.streams.left.join.stream.table.app;

import io.lgr.quickstarts.avro.KafkaCountry;
import io.lgr.quickstarts.avro.KafkaJoinPersonCountry;
import io.lgr.quickstarts.avro.KafkaPerson;
import io.lgr.quickstarts.streams.left.join.stream.table.constants.StateStore;
    ...
    public static void topology(StreamsBuilder streamsBuilder) {
        KTable<String, KafkaCountry> countryTable = streamsBuilder
                ...
                .repartition(Repartitioned
                        ...
                        .withName(Topic.COUNTRY_LEFT_JOIN_STREAM_TABLE_REKEY_TOPIC.toString()))
                .toTable(Materialized.<String, KafkaCountry, KeyValueStore<Bytes, byte[]>>as(StateStore.COUNTRY_TABLE_LEFT_JOIN_STREAM_TABLE_STATE_STORE.toString())
