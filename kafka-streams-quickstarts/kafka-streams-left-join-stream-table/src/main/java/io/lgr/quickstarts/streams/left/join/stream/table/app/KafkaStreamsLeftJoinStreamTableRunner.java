...
import io.lgr.quickstarts.streams.left.join.stream.table.properties.StreamsProperties;
...
@Slf4j
@Component
public class KafkaStreamsLeftJoinStreamTableRunner implements ApplicationRunner {
    @Autowired
