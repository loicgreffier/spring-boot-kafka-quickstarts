...
- The use of the Kafka Streams DSL: `leftJoin()` between KStream and KTable, `selectKey()`, `peek()`.
...
- Write the resulting KafkaJoinPersonCountry objects to a new topic named PERSON_COUNTRY_LEFT_JOIN_STREAM_TABLE_TOPIC.
