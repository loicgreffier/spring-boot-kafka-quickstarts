...
class KafkaStreamsFlatMapValuesApplicationTests {
    private static final String SCHEMA_REGISTRY_SCOPE =
        KafkaStreamsFlatMapValuesApplicationTests.class.getName();
    ...
    void setUp() {
        ...
        outputTopic =
            testDriver.createOutputTopic(PERSON_FLATMAP_VALUES_TOPIC, new StringDeserializer(),
    ...
    void shouldFlatMapFirstNameAndLastName() {
        ...
        assertThat(results.get(0)).isEqualTo(KeyValue.pair("1", "John"));
        assertThat(results.get(1)).isEqualTo(KeyValue.pair("1", "Doe"));
    }
