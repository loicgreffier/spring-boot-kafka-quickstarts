...
import io.github.loicgreffier.streams.flatmapvalues.app.KafkaStreamsFlatMapValuesTopology;
...
class KafkaStreamsFlatMapValuesTest {
    private static final String SCHEMA_REGISTRY_SCOPE = KafkaStreamsFlatMapValuesTest.class.getName();
