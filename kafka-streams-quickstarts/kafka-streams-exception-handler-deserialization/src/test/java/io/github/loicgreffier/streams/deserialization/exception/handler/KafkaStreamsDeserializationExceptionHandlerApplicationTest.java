package io.github.loicgreffier.streams.deserialization.exception.handler;

import static io.confluent.kafka.serializers.AbstractKafkaSchemaSerDeConfig.SCHEMA_REGISTRY_URL_CONFIG;
import static io.github.loicgreffier.streams.deserialization.exception.handler.constant.Topic.PERSON_DESERIALIZATION_EXCEPTION_HANDLER_TOPIC;
...
import io.github.loicgreffier.streams.deserialization.exception.handler.app.KafkaStreamsTopology;
import io.github.loicgreffier.streams.deserialization.exception.handler.error.CustomDeserializationExceptionHandler;
...
class KafkaStreamsDeserializationExceptionHandlerApplicationTest {
    private static final String CLASS_NAME = KafkaStreamsDeserializationExceptionHandlerApplicationTest.class.getName();
