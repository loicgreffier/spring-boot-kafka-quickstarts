...
class KafkaStreamsJoinStreamStreamApplicationTests {
    private static final String SCHEMA_REGISTRY_SCOPE =
        KafkaStreamsJoinStreamStreamApplicationTests.class.getName();
    ...
    void setUp() {
        ...
        properties.setProperty(StreamsConfig.APPLICATION_ID_CONFIG,
            "streams-join-stream-stream-test");
        ...
        rekeyLeftOutputTopic = testDriver.createOutputTopic(
            "streams-join-stream-stream-test-" + PERSON_JOIN_STREAM_STREAM_REKEY_TOPIC
        ...
        rekeyRightOutputTopic = testDriver.createOutputTopic(
            ...
            personSerde.deserializer());
        joinOutputTopic =
            testDriver.createOutputTopic(PERSON_JOIN_STREAM_STREAM_TOPIC, new StringDeserializer(),
    ...
    void shouldJoinWhenTimeWindowIsRespected() {
        ...
        // Check state store
        WindowStore<String, KafkaPerson> leftStateStore =
            testDriver.getWindowStore(PERSON_JOIN_STREAM_STREAM_STATE_STORE + "-this-join-store");
        ...
        WindowStore<String, KafkaPerson> rightStateStore =
            testDriver.getWindowStore(PERSON_JOIN_STREAM_STREAM_STATE_STORE + "-other-join-store");
    ...
    void shouldNotJoinWhenTimeWindowIsNotRespected() {
        ...
        KafkaPerson rightPerson = buildKafkaPerson("Michael", "Doe");
        rightInputTopic.pipeInput(
            new TestRecord<>("2", rightPerson, Instant.parse("2000-01-01T01:05:01.00Z")));
