...
import io.github.loicgreffier.streams.processvalues.properties.KafkaStreamsProperties;
...
@Slf4j
@Component
public class KafkaStreamsProcessValuesRunner implements ApplicationRunner {
    @Autowired
