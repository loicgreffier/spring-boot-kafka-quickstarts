 ...
 */
class KafkaStreamsProcessValuesApplicationTests {
    private static final String SCHEMA_REGISTRY_SCOPE =
        KafkaStreamsProcessValuesApplicationTests.class.getName();
    ...
    void setUp() {
        ...
        outputTopic =
            testDriver.createOutputTopic(PERSON_PROCESS_VALUES_TOPIC, new StringDeserializer(),
