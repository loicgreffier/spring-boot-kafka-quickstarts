...
import io.github.loicgreffier.streams.left.join.stream.global.table.app.KafkaStreamsLeftJoinStreamGlobalTableTopology;
...
class KafkaStreamsLeftJoinStreamGlobalTableTest {
    private static final String SCHEMA_REGISTRY_SCOPE = KafkaStreamsLeftJoinStreamGlobalTableTest.class.getName();
