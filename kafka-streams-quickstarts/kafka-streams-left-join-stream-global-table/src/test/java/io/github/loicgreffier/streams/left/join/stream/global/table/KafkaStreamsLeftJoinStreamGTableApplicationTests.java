...
import io.github.loicgreffier.streams.left.join.stream.global.table.app.KafkaStreamsTopology;
...
class KafkaStreamsLeftJoinStreamGTableApplicationTests {
    private static final String SCHEMA_REGISTRY_SCOPE = KafkaStreamsLeftJoinStreamGTableApplicationTests.class.getName();
    ...
    void setUp() {
        ...
        joinOutputTopic = testDriver.createOutputTopic(PERSON_COUNTRY_LEFT_JOIN_STREAM_GLOBAL_TABLE_TOPIC, new StringDeserializer(), joinPersonCountrySerde.deserializer());
    }
