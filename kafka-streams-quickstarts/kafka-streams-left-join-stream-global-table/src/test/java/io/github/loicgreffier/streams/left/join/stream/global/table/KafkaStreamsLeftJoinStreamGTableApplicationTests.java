...
class KafkaStreamsLeftJoinStreamGtableApplicationTests {
    private static final String SCHEMA_REGISTRY_SCOPE =
        KafkaStreamsLeftJoinStreamGtableApplicationTests.class.getName();
    ...
    void setUp() {
        ...
        properties.setProperty(StreamsConfig.APPLICATION_ID_CONFIG,
            "streams-left-join-stream-global-table-test");
        ...
        joinOutputTopic =
            testDriver.createOutputTopic(PERSON_COUNTRY_LEFT_JOIN_STREAM_GLOBAL_TABLE_TOPIC,
