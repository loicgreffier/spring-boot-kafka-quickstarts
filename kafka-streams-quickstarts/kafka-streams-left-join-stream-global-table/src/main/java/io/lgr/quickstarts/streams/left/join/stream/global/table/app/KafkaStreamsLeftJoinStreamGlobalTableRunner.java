package io.lgr.quickstarts.streams.left.join.stream.global.table.app;

import io.lgr.quickstarts.streams.left.join.stream.global.table.properties.StreamsProperties;
...
@Slf4j
@Component
public class KafkaStreamsLeftJoinStreamGlobalTableRunner implements ApplicationRunner {
    @Autowired
