...
public class KafkaStreamsTopology {
     ...
     * the {@link PutInStoreProcessor} processor that puts the records in a {@link TimestampedKeyValueStore} state
     * store. It demonstrates the two strategies to use a state store in a processor: - Using the
