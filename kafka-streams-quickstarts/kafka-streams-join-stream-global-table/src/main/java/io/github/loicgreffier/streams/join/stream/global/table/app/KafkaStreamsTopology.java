...
public class KafkaStreamsTopology {
     ...
     * io.github.loicgreffier.streams.join.stream.global.table.constants.Topic#PERSON_TOPIC} topic
     * and the {@link
     * io.github.loicgreffier.streams.join.stream.global.table.constants.Topic#COUNTRY_TOPIC}
     * topic as a global table. The stream is joined to the global table by nationality with an
     * inner join. The result is written to the
     * {@link io.github.loicgreffier.streams.join.stream.global.table.constants.Topic#PERSON_COUNTRY_JOIN_STREAM_GLOBAL_TABLE_TOPIC} topic.
     *
