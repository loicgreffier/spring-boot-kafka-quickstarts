...
import io.github.loicgreffier.streams.join.stream.global.table.properties.KafkaStreamsProperties;
...
@Slf4j
@Component
public class KafkaStreamsJoinStreamGlobalTableRunner implements ApplicationRunner {
    @Autowired
