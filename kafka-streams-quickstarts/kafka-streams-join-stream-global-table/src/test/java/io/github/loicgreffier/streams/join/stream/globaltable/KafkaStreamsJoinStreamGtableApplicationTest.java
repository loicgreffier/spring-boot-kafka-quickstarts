...
class KafkaStreamsJoinStreamGtableApplicationTest {
    private static final String CLASS_NAME = KafkaStreamsJoinStreamGtableApplicationTest.class.getName();
    ...
    void setUp() {
        ...
        properties.setProperty(APPLICATION_ID_CONFIG, "streams-join-stream-global-table-test");
