...
This module shows:
- Kafka Streams API: `join()` between KStream and GlobalKTable, `selectKey()`, `peek()`
- unit tests with Topology Test Driver

This module does:
- stream <String,KafkaPerson> records from a topic named PERSON_TOPIC
- stream <String,KafkaCountry> records from a topic named COUNTRY_TOPIC and rekey records on country code
...
- write the result into a new topic named PERSON_COUNTRY_JOIN_STREAM_GLOBAL_TABLE_TOPIC
