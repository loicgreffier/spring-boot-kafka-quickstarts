...
import io.github.loicgreffier.streams.outer.join.stream.stream.properties.StreamsProperties;
...
@Slf4j
@Component
public class KafkaStreamsOuterJoinStreamStreamRunner implements ApplicationRunner {
    @Autowired
