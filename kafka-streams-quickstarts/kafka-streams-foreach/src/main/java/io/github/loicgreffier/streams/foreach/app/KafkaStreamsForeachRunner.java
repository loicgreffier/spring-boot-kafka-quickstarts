...
import io.github.loicgreffier.streams.foreach.properties.KafkaStreamsProperties;
...
@Slf4j
@Component
public class KafkaStreamsForeachRunner implements ApplicationRunner {
    @Autowired
    ...
    public void run(ApplicationArguments args) {
        ...
        KafkaStreamsForeachTopology.topology(streamsBuilder);
