...
class KafkaConsumerRetryTest {
    ...
    void setUp() {
        ...
        kafkaConsumerProperties.getProperties().put(ConsumerConfig.AUTO_OFFSET_RESET_CONFIG, OffsetResetStrategy.EARLIEST.toString());
        consumerRunner = new KafkaConsumerRetryRunner(mockConsumer, externalService, kafkaConsumerProperties);
    }
    ...
    void shouldRewindToLatestOnExternalSystemError() throws Exception {
        KafkaConsumerProperties kafkaConsumerProperties = new KafkaConsumerProperties();
        kafkaConsumerProperties.getProperties().put(ConsumerConfig.AUTO_OFFSET_RESET_CONFIG, OffsetResetStrategy.LATEST.toString());
        consumerRunner = new KafkaConsumerRetryRunner(mockConsumer, externalService, kafkaConsumerProperties);
